...
if(params$pdf_mode){
  ...
  cat("[<i class='fas fa-download'></i> Download a PDF of this CV](https://github.com/doug2mac/doug_cv/raw/main/cv.pdf)")
}
```
...
Certifications, Skills, and Volunteer Work {data-icon=chart-line}
--------------------------------------------------------------------------------

```{r}
CV %<>% print_section('about_me')
```
